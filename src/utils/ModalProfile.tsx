...
export default function ModalProfile({ children, onClose, title, className }: { children: ReactNode; onClose: () => void; title?: string; className?: string }) {
  return (
    <div className={`overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-40 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full bg-black/50 ${className}`}>
