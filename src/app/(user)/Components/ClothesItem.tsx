      ...
      <div className="max-w-xs bg-white shadow-gray-1 rounded-lg shadow ">
        <Link href={`/product/${product.slug}`}>
          <Image
            ...
            width={240}
            height={240}
            className="object-cover w-full h-60 object-top rounded-t-lg"
            alt="kemeja"
          />
        </Link>
        <div className="p-5 relative flex-col justify-between">
          <div>
            <a href="#">
              <p className="font-bold text-[16px] tracking-wide">
                {product.nama_barang}
              </p>
            </a>
            {product.diskon && product.diskon > 0 ? (
              <>
                ...
                <p className="font-bold text-[16px] text-primary-green mb-2">
                  {product.diskon}% Lebih Hemat!
                </p>
              </>
            ) : (
            ...
            <p className="font-medium text-[14px] text-gray-3">
              {" "}
              - {product.kategori} -{" "}
            </p>
            <p className="mt-1 font-medium text-[14px] text-gray-3">
              {product.deskripsi}
            </p>
          </div>
